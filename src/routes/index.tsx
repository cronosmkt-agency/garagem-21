          ...
          <div className="grid items-center gap-12 lg:grid-cols-12">
            ...
            <div className="text-center lg:col-span-7 lg:text-left">
              ...
              <h1 className="text-4xl font-extrabold tracking-tight text-slate-900 sm:text-5xl lg:text-6xl">
                A revendedora de carros mais confiável de Teresópolis: 
                <span className="text-slate-700 underline decoration-slate-300 decoration-wavy underline-offset-8">
                  honestidade comprovada por mais de 230 clientes.
                </span>
              </h1>
              ...
              <div className="mt-10 flex flex-wrap items-center justify-center gap-3 lg:justify-start">
                ...
                <span className="text-sm text-slate-500">· 231 avaliações 100% 5 estrelas unânimes</span>
              </div>
            </div>
              ...
              <div className="relative mx-auto max-w-md rounded-3xl border border-slate-200 bg-white/90 p-8 shadow-2xl shadow-slate-900/5 backdrop-blur-xl">
                <div className="flex items-center gap-4 border-b border-slate-100 pb-6">
                  ...
                  <div>
                    ...
                    <h3 className="text-xl font-bold text-slate-900">Garagem 21 Collection</h3>
                    <p className="text-sm text-slate-500">Atendimento direto com Sr. Alexandre</p>
                  </div>
                </div>
          ...
          <div className="grid items-center gap-12 lg:grid-cols-12">
            <div className="lg:col-span-6">
              <div className="relative rounded-3xl border border-slate-200 bg-gradient-to-br from-slate-100 to-slate-200/60 p-10 text-center">
                ...
                <h3 className="mt-6 text-2xl font-bold text-slate-900">Garagem 21 Collection</h3>
                <p className="mt-2 text-sm font-medium text-slate-600">R. Ten. Luiz Meirelles, 540 - Várzea, Teresópolis - RJ</p>
                <div className="mt-6 inline-flex items-center gap-2 rounded-full bg-white px-5 py-2 text-xs font-semibold text-slate-700 shadow-sm">
                  ...
                  Segunda a Sexta das 08:30 às 18:00 | Sábados até às 13:00
                </div>
              </div>
            </div>
          ...
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
            <div>
              <div className="flex items-center gap-2">
                <span className="text-2xl">🏎️</span>
                <span className="text-lg font-bold text-slate-900">Garagem 21 Collection</span>
              </div>
            ...
            <div>
              ...
              <p className="mt-3 text-xs leading-relaxed text-slate-600">R. Ten. Luiz Meirelles, 540 - Várzea, Teresópolis - RJ</p>
            </div>

            <div>
              <h4 className="text-xs font-bold tracking-wider text-slate-900 uppercase">Horários</h4>
              <p className="mt-3 text-xs leading-relaxed text-slate-600">Segunda a Sexta das 08:30 às 18:00 | Sábados até às 13:00</p>
            </div>
