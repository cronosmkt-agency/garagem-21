...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Garagem 21 Collection — Seminovos Selecionados & Especiais | Teresópolis" },
      { name: "description", content: "A concessionária de seminovos mais confiável de Teresópolis com mais de 230 avaliações 5 estrelas. Carros com laudo cautelar aprovado e taxas reduzidas." },
      { property: "og:title", content: "Garagem 21 Collection — Seminovos Selecionados" },
      { property: "og:description", content: "Confiança que faz clientes comprarem sem ver: veículos periciados na Tenente Luiz Meirelles." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
    ],
    links: [
      { rel: "stylesheet", href: appCss },
      { rel: "icon", type: "image/svg+xml", href: "data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100'><rect width='100' height='100' rx='25' fill='%2309090b'/><rect x='4' y='4' width='92' height='92' rx='21' fill='none' stroke='%23D4AF37' stroke-width='4'/><text x='50%' y='55%' text-anchor='middle' dominant-baseline='middle' fill='%23D4AF37' font-family='sans-serif' font-weight='900' font-size='38'>G21</text></svg>" },
